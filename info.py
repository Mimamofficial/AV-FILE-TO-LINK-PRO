...
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002338165303')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002338165303')) # admin your channel in users log 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6139759254').split()] # 3567788, 678899, 5889467
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'mimam_officialx') # without @ 
...
BAN_ALERT = environ.get('BAN_ALERT' , '<b>ʏᴏᴜʀ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴛʜɪs ʙᴏᴛ.ᴄᴏɴᴛᴀᴄᴛ [ᴍᴢ ᴄʜᴀᴛ ᴏᴡɴᴇʀ](https://t.me/MRN_CONTACT_BOT) ᴛᴏ ʀᴇsᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇ!!</b>')

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rupper185:rupper185@cluster0.zeemvxe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
if HAS_SSL:
    URL = "https://subjective-silvana-mimammz-56d5e799.koyeb.app/".format(FQDN)
else:
    URL = "https://subjective-silvana-mimammz-56d5e799.koyeb.app/".format(FQDN, "" if NO_PORT else ":" + str(PORT))
