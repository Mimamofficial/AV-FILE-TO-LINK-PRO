...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        buttons = [[
	    InlineKeyboardButton('꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂', url='https://t.me/mimam_officialx')
	],[
...
# For Any Kind Of Error Ask Us In Support Group @AV_SUPPORT_GROUP
        ...
        buttons = [[
            InlineKeyboardButton('• ᴀᴅᴍɪɴ •', callback_data='https://t.me/mimam_officialx')
	],[
	    InlineKeyboardButton('• ʜᴏᴍᴇ •', callback_data='start'),
	    InlineKeyboardButton('• ᴄʟᴏsᴇ •', callback_data='close_data')
        ]]
...
# For Any Kind Of Error Ask Us In Support Group @AV_SUPPORT_GROUP
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂](https://t.me/Mrn_Officialx)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂](https://t.me/Mrn_Officialx)</b>"
